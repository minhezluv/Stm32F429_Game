...
extern const unsigned char image_car_green[]; // BITMAP_CAR_GREEN_ID = 5, Size: 35x73 pixels
extern const unsigned char image_car_red[]; // BITMAP_CAR_RED_ID = 6, Size: 35x73 pixels
