...
extern const unsigned char image_blue_icons_pause_48[]; // BITMAP_BLUE_ICONS_PAUSE_48_ID = 4, Size: 30x42 pixels
extern const unsigned char image_blue_icons_refresh_48[]; // BITMAP_BLUE_ICONS_REFRESH_48_ID = 5, Size: 46x43 pixels
extern const unsigned char image_blue_icons_remove_48[]; // BITMAP_BLUE_ICONS_REMOVE_48_ID = 6, Size: 46x46 pixels
extern const unsigned char image_button_easy[]; // BITMAP_BUTTON_EASY_ID = 7, Size: 139x72 pixels
extern const unsigned char image_button_hard[]; // BITMAP_BUTTON_HARD_ID = 8, Size: 139x72 pixels
extern const unsigned char image_button_normal[]; // BITMAP_BUTTON_NORMAL_ID = 9, Size: 139x72 pixels
extern const unsigned char image_button_play[]; // BITMAP_BUTTON_PLAY_ID = 10, Size: 66x67 pixels
extern const unsigned char image_car_green[]; // BITMAP_CAR_GREEN_ID = 11, Size: 35x73 pixels
extern const unsigned char image_car_red[]; // BITMAP_CAR_RED_ID = 12, Size: 35x73 pixels
extern const unsigned char image_finish[]; // BITMAP_FINISH_ID = 13, Size: 240x40 pixels
extern const unsigned char image_gameover[]; // BITMAP_GAMEOVER_ID = 14, Size: 240x320 pixels
extern const unsigned char image_poster[]; // BITMAP_POSTER_ID = 15, Size: 240x320 pixels
extern const unsigned char image_rock[]; // BITMAP_ROCK_ID = 16, Size: 37x24 pixels
